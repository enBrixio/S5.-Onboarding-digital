...
const tutorialData: Tutorial[] = [
  {
    ...
    description:
      "Un minim de 30 hores a la setmana. Si no en tens prou, hauràs de decar-li més hores. Al principi sembla imposiblle, però notaràs una millora rápidament",
    bgcolor: "#2EA9A9 ",
    img: time,
  },
  {
  ...
  },
  {
    ...
    description:
      "Descansar bé i desconnectar són vitals. Daquesta manera reduiràs l'estres ' l'ansiestat. Milloraràs la teva concentració i consolidaràs el teu aprenentatge",
    bgcolor: "#F4D03F ",
    img: meditacion,
  },
];
